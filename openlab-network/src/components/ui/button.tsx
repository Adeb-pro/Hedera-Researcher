...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 shadow-sm",
  {
    variants: {
      variant: {
        default: "bg-primary-600 text-white hover:bg-primary-700 hover:shadow-lg shadow-primary-600/20",
        destructive: "bg-red-600 text-white hover:bg-red-700 shadow-red-600/20",
        outline: "border border-input bg-background hover:bg-accent hover:text-accent-foreground backdrop-blur-sm",
        secondary: "bg-secondary-600 text-white hover:bg-secondary-700 shadow-secondary-600/20",
